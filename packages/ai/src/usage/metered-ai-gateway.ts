import type { AiRequest, AiResponse, AiStructuredRequest } from "../contracts/types.js";
...
export interface BillingContext { organizationId: string; userId: string; projectId?: string; environmentId?: string; operationType: string; idempotencyKey: string; reservationUnits: bigint; provider: string; model: string; }
