...
export class TestAiProvider implements AiProvider {
  ...
  constructor(private readonly options: { text?: string; structured?: unknown; behavior?: Behavior; transientFailures?: number; usage?: { inputTokens?: number; outputTokens?: number; totalTokens?: number } } = {}) {}
